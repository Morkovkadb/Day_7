...
void make_picture(int **picture, int n, int m) {
  ...
  int length_w = sizeof(frame_w) / sizeof(frame_w[0]);
  int length_h = sizeof(frame_h) / sizeof(frame_h[0]);
  int length_trunk = sizeof(tree_trunk) / sizeof(tree_trunk[0]);
  int length_foliage = sizeof(tree_foliage) / sizeof(tree_foliage[0]);
  int l_sun = sizeof(sun_data) / sizeof(sun_data[0]);
  int l2_sun = sizeof(sun_data[0]) / sizeof(sun_data[0][0]);
